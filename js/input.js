   // API Basic Configuration Object (AutoComlete https://tarekraafat.github.io/autoComplete.js/#/usage)
   const countryList = [
    ...
    const autoCompleteJS = new autoComplete({ 
            ...
            resultsList: {
                maxResults: 15, // максимальное количесво найденых сразу стран
            },
            searchEngine: 'strict', // при наборе в поиске символы будет искать рядом стоящие
